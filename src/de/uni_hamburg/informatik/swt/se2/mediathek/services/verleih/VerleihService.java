...
public interface VerleihService extends ObservableService
{
    ...
    /**
     * Merkt eine Liste von Medien fuer einen Kunden vor
     *
     * @param kunde Kunde
     * @param medien Liste von Medien die Verliehen werden
     *
     * @require kundeImBestand(kunde)
     */
    ...
    /**
     * Gibt die Vormerkkarte fuer ein bestimmtes Medium
     *
     * @param medium
     * @return Vormerkkarte passend zum Medium
     */
    Vormerkkarte getVormerkkarteFuer(Medium medium);

    /**
     * Gibt den Vormerker an einer bestimmten stelle in der Vormerker Queue
     *
     * @param medium
     * @param index
     *
    ...
    /**
     * Prueft ob das Vormerken eines Kunden fuer eine Liste von Medien moeglich ist
     *
     * @param kunde
     * @param medien
     * @return true oder false fuer ob vormerken moeglich
     */
